...
/**
 * <p>This class encapsulates scrolling. You can use scrollers ({@link FastScroller}
...
public class FastScroller {
     ...
     */
    public FastScroller(Context context, Interpolator interpolator) {
     ...
     */
    public FastScroller(Context context, Interpolator interpolator, boolean flywheel) {
        mFinished = true;
        ...
        if (timePassed < mDuration) {
            switch (mMode) {
                ...
                case FLING_MODE:
                    ...
                    mCurrX = mStartX + Math.round(distanceCoef * (mExtendedFinalX - mStartX));
                    ...
                    if (mDirectionX < 0 && mCurrX <= mFinalX) {
                        // scroll right
                        mCurrX = mFinalX;
                        mFinished = true;
                    } else if (mDirectionX > 0 && mCurrX >= mFinalX) {
                        // scroll left
                        mCurrX = mFinalX;
                        mFinished = true;
                    }
    ...
    public void fling(int startX, int startY, int velocityX, int velocityY,
        ...
        mExtendedFinalX = startX + (int) Math.round(totalDistance * coeffX);
        mFinalX = mExtendedFinalX;
        ...
        mDirectionX = mFinalX > mStartX ? 1 : -1;
    }
